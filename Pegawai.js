...
class Pegawai extends Component {
    ...
    Add = () => {
        //mengosongkan isi variable nip, nama, dan alamat
    ...
    Edit = (item) => {
        // -mengisikan isi variable nip, nama, alamat sesuai dengan data yang akan di edit
    ...
    SavePegawai = (event) => {
        ...
        //menampung data nip, nama, dan alamat dari Form ke dalam
        //formData() untuk dikirim
        let url = "";
        ...
        //mengiri, data ke API untuk disimpan pada database
        axios.post(url, form)
        .then(response => {
    ...
    componentDidMount() {
        ...
        this.getPegawai()
        // axios.get('http://localhost:2910/pegawai').then((res) => {
        //     console.log(res.data.pegawai)
        //     this.setState({pegawai: res.data.pegawai})
        // }).catch((err) => { throw err })
    }
        ...
        return (
            <div className="m-3 card">
                ...
                <div className="card-body">
                    <input type="text" className="form-control mb-2" name="search"
                        value={this.state.search} onChange={this.bind} onKeyUp={this.findPegawai}
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            <div className="modal" id="edit-modal" style={{position: 'absolute',display:'fixed', top: '50%', left: '50%', transform: `translate(-50%,-50%)` }}>
